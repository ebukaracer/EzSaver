...
namespace Racer.EzSaver.Scripts.Runtime.Core
{
    ...
    /// </summary>
    /// <remarks>
    /// This class is designed to be used with <see cref="EzSaverManager"/> for managing save-files.
    /// </remarks>
    public class EzSaverCore : EzSaverBase
    {
        ...
        internal EzSaverCore(string contentSource, bool isJsonStringLiteral = false, bool useSecurity = false)
            : this(contentSource, isJsonStringLiteral,
                new EzSaverSettings(new FileReader(contentSource), new AesEncryptor(), EzSaverConfig.Instance, useSecurity))
        {
        }
